    ...
    <Modal title="查看详情" width={1200} visible={props.visible} onCancel={props.onCancel}>
      <ProCard title="基本信息" bordered headerBordered>
        <Form title="基本信息" submitter={false}>
          ...
          <Row gutter={[48, 48]}>
            <Col span={8}>
              <Form.Item label="头像">{currentPatient?.electronicMedicalRecord?.avatar}</Form.Item>
            </Col>
            <Col span={8}>
              <Form.Item label="住院号">
          ...
          <Row gutter={[48, 48]}>
            <Col span={8}>
              <Form.Item label="用户记录">
                {currentPatient?.electronicMedicalRecord?.recordUser}
              </Form.Item>
            </Col>
            <Col span={8}>
